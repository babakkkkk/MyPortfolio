...
export class BannerComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  setMyNameTextAlign(text: string)
  {    
    var p = /[\u0600-\u06FF]/;
    if (p.test(text))
      return "direction:rtl;text-align: right;font-family: 'Persian'; max-width: 500px;font-weight: 600;font-size: 30px;line-height: 1.7;margin: 0;color: $LightestSlate;"
    else
      return "font-weight: 600;font-size: 60px;line-height: 1.5;margin: 0;font-family: $MainFont;color: $LightestSlate;"
  }
  // setMyNameClass(text: string)
  // {    
  //   var p = /[\u0600-\u06FF]/;
  //   if (p.test(text))
  //     return "";
  ...
  //     return "banner-name";
  // }
  setTitleTextAlign(text: string)
  {    
    var p = /[\u0600-\u06FF]/;
    if (p.test(text))
      return "direction:rtl;font-family: 'Persian';text-align: right; max-width: 500px; font-size: 30px;line-height: 1.7;";
    else
      return "font-weight: 600;font-size: 60px;line-height: 1.5;margin: 0;font-family: $MainFont;color: $LightestSlate;";
  }
  setPreTitleTextAlign(text: string)
  {    
    var p = /[\u0600-\u06FF]/;
    if (p.test(text))
      return "font-family: 'Persian';direction:rtl;text-align: right; max-width: 500px; font-size: 20px; line-height: 1.5;";
    else
      return "font-family: $MainFont;color: $LightestSlate;";
  }
